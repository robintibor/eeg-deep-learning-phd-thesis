...
# ```{admonition} Cropped training has potential to improve performance on small EEG datasets
# :class: tip
# * In which settings (datasets/architectures) does it help or hurt?
# ```
