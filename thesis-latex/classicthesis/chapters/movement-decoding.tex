...
\begin{figure}[htb]
    ...
    \subfloat[]
    {
        \includegraphics[width=1\linewidth]{images/Final_Comparison.ipynb.9.pdf-1.png} 
    } \\
    \subfloat[]
    {
    \includegraphics[width=1\linewidth]{images/Final_Comparison.ipynb.10.pdf-1.png}
    }
